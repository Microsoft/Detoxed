...
class DeploymentCondition(ABC):
    ...
    def is_met(self) -> bool:
        """If condition is met, True. Otherwise False."""

    @abstractmethod
    def timeout(self) -> int:
        """Time allowed to wait for condition to be met."""
...
class DefaultDeploymentCondition(DeploymentCondition):
    ...
    def timeout(self) -> int:
        """Timeout is irrelevant for this condition."""
        return 0


class CommandRunner():
    """Run OS level command."""
...
class IoTEdgeDeploymentFinishedCondition(DeploymentCondition):
    """
    Deployment condition that will block on Azure IoT Edge deployment.
    ...
    def __init__(
        ...
        """Initialize with IoT parameters."""
    ...
    def is_met(self) -> bool:
        """Determine if the target device deployment count matches the actual device deployment count."""
